    ...
    def create_database_if_not_exists(self):
        ...
        try:
            ...
            if self.database.lower() not in databases:
                ...
                cursor.execute(f"CREATE TABLE {self.database}.borrowers (bid int primary key auto_increment not null, borrower_name varchar(100), borrower_address varchar(100), borrowed_item varchar(100), barcode varchar(50), purpose varchar(255), date_borrowed datetime, date_return datetime);")
